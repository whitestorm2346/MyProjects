...
int int_SeatNum[40];    //人數
int intarr_V1[6][7], intarr_V2[6][7];   //座位
        ...
        case 1:
            ...
            for(int i = 0; i < 6; i++)
            {
                for(int j = 0; j < 7; j++)
                {
                    ...
                    if(int_Mode == 2) fn_Delay(db_Time);
...
int main()
{
	...
	do
	{
		...
		while(true)
		{
			...
			if(int_Mode == 1 || int_Mode == 2) break;
        ...
        do
        {
            ...
            switch(int_Mode)
            {
                ...
                case 2:
                    ...
                    int_Time = 1000 * db_Second;

                    switch(int_Vision)
                    {
                        case 1: fn_Display(1, 2, int_Time); break;
                        case 2: fn_Display(2, 2, int_Time); break;
                    }
